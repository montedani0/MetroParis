...
class Model:
    ...
    def addEdgesPesatiTempi(self):
        """Questo metedo crea degli archi, in cui il peso è pari al tempo di percorrenza
        di quell'arco ottenuto come rapporto fra la distanza fra due stazioni"""
